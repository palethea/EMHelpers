...
public final class HudLayoutEditorChrome {
	...
	public static void drawOutline(GuiGraphicsExtractor context, int x, int y, int width, int height) {
	...
	public static void drawResizeHandle(GuiGraphicsExtractor context, int x, int y, int width) {
		int handleX = x + width - HANDLE_SIZE;
		int handleY = y;
		context.fill(handleX, handleY, handleX + HANDLE_SIZE, handleY + HANDLE_SIZE, HANDLE_COLOR);
	}

	public static void drawOpacityButton(GuiGraphicsExtractor context, int x, int y) {
	...
	public static void drawSnapGuides(GuiGraphicsExtractor context, List<HudLayoutSnapping.GuideLine> guides, int screenWidth, int screenHeight) {
